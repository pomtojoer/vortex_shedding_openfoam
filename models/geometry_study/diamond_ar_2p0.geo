...
Point(19) = {-diamond_length, 0, 0, 1.0};
Point(20) = {0, diamond_thickness, 0, 1.0};
Point(21) = {0, -diamond_thickness, 0, 1.0};
// ********************************************************
...
// ********************  Physical planes  ********************
Physical Surface("in") = {37, 191, 181};
Physical Surface("out") = {93, 103, 125};
Physical Surface("sym2") = {169, 147, 137};
Physical Surface("sym1") = {49, 59, 81};
Physical Surface("back") = {1, 2, 3, 4, 5, 6, 7, 8, 9};
Physical Surface("front") = {50, 72, 94, 116, 138, 160, 182, 204, 246};
Physical Surface("obstacle") = {245, 233, 237, 241};
// ********************************************************
